%%% -*- Mode: LaTeX; -*-
%       RCS: $Id: README.tex,v 1.1 2018-01-01 20:51:24 lsipusr Exp $
...
bisos.examples: python libraies, python scripts and Interactive Command Modules (ICM)
to provide templates and to illustrate, examine and test BISOS (ByStar Internet Services OS) features.

The following suffixes and prefixes are used to indicate purpose.

\begin{itemize}
\item Example  -- Code/text that illustrates a particular usage
\item Begin    -- A Template to be used as a beginning point for new code
\item Start    -- Script that insert ``Begin'' for new code
\end{itemize}
